...
return [
    'welcome'                => 'بەخێربێیت بۆ قیبلەنمای ڤۆیەیجەر (SHJARAH). هەموو ئەپڵیکەیشنێک پێویستی بە قیبلەنمایەکە بۆ نیشاندانی ڕێی ڕاست.
    ...
    'links'         => [
        ...
        'voyager_homepage'      => 'پەڕەی سەرەتای ڤۆیەیجەر (SHJARAH)',
        'voyager_hooks'         => 'هووکەکانی ڤۆیەیجەر (SHJARAH)',
    ],
    'commands'      => [
        'title'                 => 'ناونیشان',
