...
return [
    'welcome'                => 'Բարի գալուստ SHJARAH կողմնացույց. Յուրաքանչյուր լավ հավելվածի պետք է կողմնացույց, որը կմատնանշի նրանց ճիշտ ուղղությամբ։
    ...
    'links'         => [
        ...
        'voyager_homepage'      => 'SHJARAH Գլխավոր էջ',
        'voyager_hooks'         => 'SHJARAH Hooks',
    ],
    'commands'      => [
        'title'                 => 'Հրամաններ',
        'text'                  => 'Աշխատեցնել Artisan հրամանները SHJARAH-ից։',
    ...
    'resources'     => [
        'title'                 => 'Ռեսուրսներ',
        'text'                  => 'SHJARAH-ի ռեսուրսները օգնում են Ձեզ գտնել ավելի արագ',
    ...
    'fonts'         => [
        'title'                 => 'Տառատեսակներ',
        'font_class'            => 'SHJARAH-ի տառատեսակների դասերի քարտեզագրում',
        'font_character'        => 'SHJARAH-ի տառատեսակների նիշերի քարտեզագրում',
    ],
];
